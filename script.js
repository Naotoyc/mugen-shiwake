...
const SIMILAR_ACCOUNTS = {
  '現金':                     ['普通預金', '仮払金', '当座預金', '小口現金', '当座借越'],
  '普通預金':                 ['現金', '当座預金', '借入金', '小口現金', '未払金'],
  '売掛金':                   ['買掛金', '未収入金', 'クレジット売掛金', '受取手形', '前払金'],
  '買掛金':                   ['売掛金', '未払金', '支払手形', '電子記録債務', '仕入'],
  ...
  '発送費':                   ['旅費交通費', '通信費', '消耗品費', '支払手数料', '現金'],
  '支払手数料':               ['発送費', 'クレジット売掛金', '通信費', '受取手数料', '旅費交通費'],
  ...
  '売上':                     ['仕入', '前受金', '売掛金', '受取利息', '受取手数料'],
  '仕入':                     ['売上', '消耗品費', '買掛金', '発送費', '前払金'],
  '受取利息':                 ['売上', '普通預金', '貸倒引当金戻入', '受取手形'],
  '借入金':                   ['普通預金', '未払金', '支払手形', '当座借越', '現金'],
  '損益':                     ['繰越利益剰余金', '売上', '仕入', '給料'],
  '繰越利益剰余金':           ['損益', '未払配当金', '普通預金', '売上'],
  '未払配当金':               ['繰越利益剰余金', '未払金', '普通預金', '損益'],
  '社会保険料':               ['預り金', '給料', '未払金', '現金', '普通預金'],
  '支払利息':                 ['借入金', '未払費用', '未払金', '支払手数料', '支払家賃'],
  '仮払消費税':               ['仮受消費税', '未払消費税', '現金', '普通預金', '仕入'],
  '仮受消費税':               ['仮払消費税', '未払消費税', '売上', '現金', '普通預金'],
  '未払消費税':               ['仮払消費税', '仮受消費税', '未払金', '現金', '普通預金'],
  '当座預金':                 ['普通預金', '現金', '当座借越', '受取手形', '支払手形'],
  '当座借越':                 ['当座預金', '借入金', '普通預金', '未払金', '現金'],
  '現金過不足':               ['現金', '雑益', '雑損', '仮払金', '仮受金'],
  '雑益':                     ['雑損', '現金過不足', '受取利息', '売上', '現金'],
  '雑損':                     ['雑益', '現金過不足', '消耗品費', '支払手数料', '現金'],
  '前払費用':                 ['未払費用', '前払金', '未収収益', '保険料', '現金'],
  '未払費用':                 ['前払費用', '未払金', '支払利息', '給料', '現金'],
  '未収収益':                 ['前受収益', '未収入金', '受取利息', '売掛金', '現金'],
  '前受収益':                 ['未収収益', '前受金', '売上', '未払費用', '普通預金'],
  '消耗品':                   ['消耗品費', '備品', '仕入', '前払金', '現金'],
  '修繕費':                   ['消耗品費', '備品', '未払金', '現金', '普通預金'],
  '資本金':                   ['繰越利益剰余金', '現金', '普通預金', '損益', '未払配当金'],
  '小口現金':                 ['現金', '普通預金', '消耗品費', '旅費交通費', '発送費'],
  '電子記録債権':             ['売掛金', '受取手形', '電子記録債務', '未収入金', '普通預金'],
  '電子記録債務':             ['買掛金', '支払手形', '電子記録債権', '未払金', '普通預金'],
  '支払家賃':                 ['受取家賃', '未払費用', '支払利息', '前払費用', '租税公課'],
  '受取家賃':                 ['支払家賃', '前受収益', '受取利息', '売上', '普通預金'],
  '保険料':                   ['前払費用', '支払家賃', '租税公課', '通信費', '現金'],
  '受取手数料':               ['支払手数料', '受取利息', '売上', '普通預金', '売掛金'],
};
...
function generateOptions(correctAccounts) {
  ...
  let filler = pool.slice(0, targetCount - correct.length);

  // pool不足時はACCOUNT_LISTからランダム補填
  if (filler.length < targetCount - correct.length) {
    const extra = ACCOUNT_LIST.filter(a => !seen.has(a));
    for (let i = extra.length - 1; i > 0; i--) {
      const j = Math.floor(Math.random() * (i + 1));
      [extra[i], extra[j]] = [extra[j], extra[i]];
    }
    filler = [...filler, ...extra.slice(0, targetCount - correct.length - filler.length)];
  }

  const options = [...correct, ...filler];
